...
LRESULT
defScreenSaverProc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
...
LRESULT
WINAPI realScreenSaverProc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
	switch (msg)
	{
		case WM_CREATE:
...
setBestPixelFormat(HDC hdc)
{
	...
	{  // Just in case a best pixel format wasn't found
...
void
updateFrameRateLimitSlider(HWND hdlg, int sliderID, int textID)
{
...
void
readFrameRateLimitFromRegistry()
{
	LONG result;
	HKEY skey;
